...
async def chat(dados: dict = Body(...)):
    ...
    contexto = (
        ...
        "=== REGRAS CRITICAS ===\n"
        "=== CALCULO AUTOMATICO OBRIGATORIO ===\n"
        "QUANDO o motorista informa valores que vai fazer (ex: '500 hoje, 600 amanha, 600 sabado'):\n"
        "  1. CALCULE liquido de cada dia: bruto × 0.78 (descontando ~22% de combustivel)\n"
        "     Ex: 500 bruto → 390 liq | 600 bruto → 468 liq\n"
        "  2. SOME os liquidos de todos os dias informados\n"
        "  3. COMPARE com a conta mais urgente (primeiro vencimento)\n"
        "  4. RESPONDA: 'Com esses X dias voce tem R$Y liquido — isso paga [conta] (R$Z) e sobram R$W'\n"
        "  5. DISTRIBUA o restante nas outras contas por prioridade\n"
        "NUNCA peca mais detalhes quando ja tem valores numericos na conversa.\n"
        "\n"
        "QUANDO perguntarem 'qual a solucao', 'o que fazer', 'consigo pagar', 'da pra pagar':\n"
        "  1. RELEIA o historico — pegue os valores que o motorista ja informou nessa conversa\n"
        "  2. SOME os liquidos ja informados (ou use a media do historico se nao informou)\n"
        "  3. RESPONDA com plano concreto por conta, ex:\n"
        "     'Com 500+600 voce tem R$858 liquido em 2 dias. Isso paga o carro (R$740) e sobram R$118.'\n"
        "     'No sabado (R$468): compra o tenis (R$180), sobram R$288.'\n"
        "     'Elaine (R$960): parcela em 6x de R$160. Paga R$160 agora e negocia o resto.'\n"
        "\n"
        "PARCELAMENTO PROATIVO — sempre que conta > R$400 e prazo > 4 dias:\n"
        "  Sugira: 'Elaine (R$960) da pra parcelar — paga R$160 agora e combina mais 5x. Quer que eu registre assim?'\n"
        "\n"
