  ...
  "scenes": [
    {
      ...
      "veo3_prompt": "complete ready-to-paste English prompt: global anchor + character sheet + environment + action/emotion/camera + ONE single dialogue line at the end. CRITICAL: the speaking character must be the FIRST character described in the scene action (the main character of that scene). Format: MAIN SPEAKER [Name] — [full physical description repeated inline] — [voice description: e.g. deep heroic male voice / high-pitched villain voice / warm energetic female voice / soft wise elder voice, matching the character personality] — says in Brazilian Portuguese: \"frase longa educativa com 20 a 30 palavras ensinando algo concreto sobre o tema, ocupando os 8 segundos inteiros do video.\" All other characters in the scene are SILENT. Lip sync, emotional voice acting, character speaks from start to end of scene, no subtitles, no text on screen",
