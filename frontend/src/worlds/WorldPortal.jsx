...
const WORLDS = [
  ...
  },
  {
    ...
    gradient:'linear-gradient(160deg, #1a0a0a 0%, #2a0f0f 60%, #130606 100%)',
    ...
    >
      ...
      <div style={{position:'relative',zIndex:2,padding: isMobile ? '16px 16px 14px' : '28px 26px 24px',display:'flex',flexDirection:'column',flex:1}}>
        ...
        <h2 style={{
          ...
          fontSize: isMobile ? 'clamp(16px,3.5vw,20px)' : 'clamp(16px,1.4vw,24px)',
          fontWeight:800,
          color: hovered ? world.accent : '#fff',
          margin: isMobile ? '0 0 4px' : '0 0 12px', lineHeight:1.1, letterSpacing:'-0.5px', wordBreak:'break-word', overflowWrap:'break-word',
